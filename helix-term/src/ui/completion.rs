    ...
    fn format(&self, _data: &Self::Data) -> menu::Row {
        ...
        menu::Row::new(vec![
            ...
            menu::Cell::from(match self.item.kind {
                Some(lsp::CompletionItemKind::TEXT) => "text :3",
                Some(lsp::CompletionItemKind::METHOD) => "method :3",
                Some(lsp::CompletionItemKind::FUNCTION) => "function :3",
                Some(lsp::CompletionItemKind::CONSTRUCTOR) => "constructor :3",
                Some(lsp::CompletionItemKind::FIELD) => "field :3",
                Some(lsp::CompletionItemKind::VARIABLE) => "variable :3",
                Some(lsp::CompletionItemKind::CLASS) => "class :3",
                Some(lsp::CompletionItemKind::INTERFACE) => "interface :3",
                Some(lsp::CompletionItemKind::MODULE) => "module :3",
                Some(lsp::CompletionItemKind::PROPERTY) => "property :3",
                Some(lsp::CompletionItemKind::UNIT) => "unit :3",
                Some(lsp::CompletionItemKind::VALUE) => "value :3",
                Some(lsp::CompletionItemKind::ENUM) => "enum :3",
                Some(lsp::CompletionItemKind::KEYWORD) => "keyword :3",
                Some(lsp::CompletionItemKind::SNIPPET) => "snippet :3",
                Some(lsp::CompletionItemKind::COLOR) => "color :3",
                Some(lsp::CompletionItemKind::FILE) => "file :3",
                Some(lsp::CompletionItemKind::REFERENCE) => "reference :3",
                Some(lsp::CompletionItemKind::FOLDER) => "folder :3",
                Some(lsp::CompletionItemKind::ENUM_MEMBER) => "enum_member :3",
                Some(lsp::CompletionItemKind::CONSTANT) => "constant :3",
                Some(lsp::CompletionItemKind::STRUCT) => "struct :3",
                Some(lsp::CompletionItemKind::EVENT) => "event :3",
                Some(lsp::CompletionItemKind::OPERATOR) => "operator :3",
                Some(lsp::CompletionItemKind::TYPE_PARAMETER) => "type_param :3",
                Some(kind) => {
